...
class Face:
    ...
    def callback_blink(self, tm):
        if self.blink > 4:
            ...
            return
        self.blink += 2
        print("blink", (time.time_ns()-self.start_time)/1000000000)
        self.drawFace()
        return
    #
    #
    def start_blink(self):
        print("start blink", (time.time_ns()-self.start_time)/1000000000)
        self.moving = True
        self.blink=0
    ...
    def stop_blink(self):
        ...
        self.next_blink=(80 + random.random()*40) * self.update_rate
        self.blink=-100
        print("stop blink", (time.time_ns()-self.start_time)/1000000000)
